...
This is a skeleton application using the PacificNM layer and module
systems. This application is meant to be used as a starting place for those
looking to get their feet wet with PacificNM.

## Installation using Composer

The easiest way to create a new PacificNM project is to use
